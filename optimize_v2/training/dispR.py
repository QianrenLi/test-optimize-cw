...
if __name__ == '__main__':
    ...
    # loss_path = f"logs/log-loss-2023-06-23-18:25:36.txt"
    # cost_path = f"logs/log-cost-2023-06-23-18:24:57.txt"
    # loss_path = f"logs/log-loss-2023-06-24-19:44:44.txt"
    # cost_path = f"logs/log-cost-2023-06-24-19:44:05.txt"
    # dispLoss(loss_path,1)
    # dispValue(cost_path, 1, 0.9)
    loss_path = f"logs/log-loss-2023-06-27-00:15:46.txt"
    cost_path = f"logs/log-cost-2023-06-27-00:15:06.txt"
    dispLoss(loss_path,1)
    dispValue(cost_path, 1, 0.9)
